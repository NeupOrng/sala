...
<template>
  <div class="my-4 p-6 bg-white rounded-lg shadow-md">
    <!-- Question Text -->
    <div class="mb-6">
      <h3 class="text-lg font-semibold text-gray-700">Question Text</h3>
      <p class="mt-2 text-gray-900">{{ question.text || 'No question text provided' }}</p>
    </div>
    ...
    <div class="mb-6">
      ...
      <div class="mt-2">
        ...
        <p v-if="!question.options || question.options.length === 0" class="text-gray-500">
          No options provided
        </p>
      </div>
    </div>
    ...
    <div class="mb-6">
      ...
      <p class="mt-2 text-gray-900">
        {{ question.options[question.correctAnswer] ?? 'No correct answer selected' }}
      </p>
    </div>
